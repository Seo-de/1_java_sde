...
// model : 비즈니스 로직(데이터 가공, 관리, DB 연결 등) - 화면출력, run 말고는 여기서 작성
// service : 기능 제공용 클래스
...
//	}
	...
	public Student[] selectName(String name) {
		...
		// 메서드 종료 시 반환 (반환은 무조건 하나만 가능. 그래서 여러 객체를 담을 수 있는 바구니 만들기)
