...
public class whileExample {
	...
	public void ex2() {
		...
		// 하지만 input 변언 선언 시 초기화 되어있지 않으면
		// 조건식 수행을 못하기 때문에
	...
	public void ex3() {
		...
		while(input != 9) {
			...
			System.out.println();
			 ...
			 //콤마 찍는법 1
			  if(flag && (input >= 1 && input <= 4)) { // (논리형인 boolean이래) true 인 경우(첫 주문X, 메뉴를 잘 입력 했을 때
			 
				menu += ", ";
				
			}else { // false인 경우 실행 (첫 주문) 실행
				flag = true;
