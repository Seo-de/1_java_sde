...
public class Student {
	...
	public Student(String name, int age, String address, char gender, int socre) {
		super();
		this.name = name;
		this.age = age;
...
//	@Override
//	public boolean equals(Object obj) { // 동등비교
//		
...
//				this.address.equals(other.address) && this.gender == other.gender &&
