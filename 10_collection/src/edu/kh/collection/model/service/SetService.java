...
public class SetService {
	...
	public void ex1() {
		...
		Iterator<String> it = set.iterator(); // 타입을 제한하겠다
	...
	public void ex2() {
		 ...
		 *  
		 *  hashCode() : 객체에 저장된 필드를 이용해서 만들어진 정수를 반환  // 메모리를 효율적으로 쓰기위해
		 *  
	...
	public void ex3() {
		...
		System.out.println(Integer.MAX_VALUE); //* MAX_VALUE 는 public 이면서  static
		...
		int i2 = i1;	 // int = Integer
						 // int = Integer.intValue(); (int) //* 해당 객체에 값만 얻어오는거
		...
		while(lotto.size()<6) {
			...
			lotto.add(ran);  // TreeSet으로 알아서 중복제거 해주고 순서대로 해주고
		}
