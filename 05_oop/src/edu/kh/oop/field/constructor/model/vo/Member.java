package edu.kh.oop.field.constructor.model.vo;
...
public class Member {
	...
	private String memberPhone; // 전화번호의 맨 앞 0이 사라지니까 String을 쓴데
	private int memberAge;
	
	// 생성자(객체를 생성할 때 사용하는 기능)
	
	// 생성자 작성 규칙 1. 클래스명 == 생성자명
	// 생성자 작성 규칙 2. 반환형 X public void ex() 일때 void가 반환형이래
	...
	// this() 생성자
	// - 생성자를 이용한 필드 초기화 구무의 중복을 없애고, 재사용성을 늘리기 위한 기능
	...
	public Member(String memberId, int memberAge, String memberPhone) {
		...
		this(memberAge, memberPhone); // this() 생성자 호출 // 이 조합의 생성자 찾아서 호출 // 참고로만 알고있으래.
