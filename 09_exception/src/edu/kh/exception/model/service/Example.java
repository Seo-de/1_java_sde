...
public class Example {
	...
	public void ex1() {
		...
		System.out.print("입력 : ");
//		String input = br.readLine(); // sc.nextLine(); 이랑 같은 구문
	...
	public void ex3() {
		...
		// 입력 받은 두 정수 나누기
		 ...
		 try {
			 ...
			 // Unreachable catch block for ArithmeticException. (도달할수없어)
			 // It is already handled by the catch block for Exception (앞에서 예외 다 처리해서)
	...
	public void ex4() {
		...
		try {
			ex5(); // throw new IOException(); 얘가 던져저서 옴-2
		} catch (IOException e) {
	...
	public void ex5() throws IOException {
		...
		ex6(); // throw new IOException(); 얘가 던져저서 옴-1
